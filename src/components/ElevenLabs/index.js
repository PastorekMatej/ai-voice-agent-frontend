// ElevenLabs Components Index
// Central export point for all ElevenLabs components

export { default as ElevenLabsVoiceAgent } from './VoiceAgent/ElevenLabsVoiceAgent';
